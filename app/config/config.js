...
export const DATABSE="mongodb+srv://ridoy:ridoy123@webdevs.49hgn.mongodb.net/assingment_mod_21";
export const JWT_KEY="ABC12341241234"
export const JWT_EXPIRE_TIME=30*24*60*60*1000

export const EMAIL_HOST="127.0.0.1"
...
export const storeId="xxx"
export const storePassword="xxx"
export const currency="BDT"
export const cancelURI=""
export const failURI=""
export const successURI=""
